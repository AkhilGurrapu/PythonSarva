export const customerSegmentation = {
  ...
  content: `
    ...
    <h4>Example: RFM Analysis Query</h4>
    <pre>
    WITH rfm_data AS (
      SELECT 
        customer_id,
    ...
    <p>This query performs an RFM analysis to segment customers based on their recent purchase activity, purchase frequency, and total spend.</p>
  `,
