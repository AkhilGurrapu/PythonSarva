...
INSERT INTO customers (id, name, email, city, state, country) VALUES 
    (1, 'John Doe', 'john.doe@datasarva.com', 'New York', 'NY', 'USA'),
    (2, 'Jane Smith', 'jane.smith@datasarva.com', 'Los Angeles', 'CA', 'USA'),
    (3, 'Robert Johnson', 'robert.johnson@datasarva.com', 'Chicago', 'IL', 'USA'),
    (4, 'Emily Brown', 'emily.brown@datasarva.com', 'Houston', 'TX', 'USA'),
    (5, 'Michael Davis', 'michael.davis@datasarva.com', 'Phoenix', 'AZ', 'USA'),
    (6, 'Sarah Wilson', 'sarah.wilson@datasarva.com', 'Seattle', 'WA', 'USA'),
    (7, 'David Martinez', 'david.martinez@datasarva.com', 'Miami', 'FL', 'USA'),
    (8, 'Jennifer Taylor', 'jennifer.taylor@datasarva.com', 'Boston', 'MA', 'USA'),
    (9, 'Christopher Anderson', 'chris.anderson@datasarva.com', 'San Francisco', 'CA', 'USA'),
    (10, 'Lisa Thomas', 'lisa.thomas@datasarva.com', 'Denver', 'CO', 'USA'),
    (11, 'Mark Jackson', 'mark.jackson@datasarva.com', 'Atlanta', 'GA', 'USA'),
    (12, 'Elizabeth White', 'elizabeth.white@datasarva.com', 'Dallas', 'TX', 'USA'),
    (13, 'James Harris', 'james.harris@datasarva.com', 'Portland', 'OR', 'USA'),
    (14, 'Mary Clark', 'mary.clark@datasarva.com', 'Las Vegas', 'NV', 'USA'),
    (15, 'Daniel Lewis', 'daniel.lewis@datasarva.com', 'Nashville', 'TN', 'USA');
